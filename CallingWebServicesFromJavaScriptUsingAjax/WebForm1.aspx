<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CallingWebServicesFromJavaScriptUsingAjax.WebForm1" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function GetStudentById() {
           ...
           CallingWebServicesFromJavaScriptUsingAjax.StudentService.GetStudentByID(id, GetStudentByIdSuccessCallback, GetStudentByIdFailedCallback);
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>The time below does not change, when we click Get Student button as we are doing partial page post back and not a full page postback.
        </h1>
